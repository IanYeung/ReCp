...
class SingleFrameCompressModel(BaseModel):
    """Compress model for compression modeling."""

    def __init__(self, opt):
        super(SingleFrameCompressModel, self).__init__(opt)
...
@MODEL_REGISTRY.register()
class SingleFrameCondCompressModel(BaseModel):
    """Compress model for compression modeling."""

    def __init__(self, opt):
        super(SingleFrameCondCompressModel, self).__init__(opt)
